...
public interface MessageMapper {
    ...
    @Results({
            @Result(property = "replays", column = "temp_id", many = @Many(select = "com.AmyLin.em.mapper" +
    ...
    @Results({
            @Result(property = "replays", column = "id", many = @Many(select = "com.AmyLin.em.mapper.ReplayMapper" +
                    ".findAllById"))
    })
